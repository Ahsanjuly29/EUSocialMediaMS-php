                       ...
                       <nav class="main-menu">
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav"> <!--== manin menu ==-->
                               <li class="dropdown">
									<a class="dropbtn smoth-scroll" href="index.php" style="padding-bottom:0;">Home</a>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="single-post wow fadeInUp" data-wow-delay="0.4s"> <!-- single post -->
                            ...
                            <div class="entry-content">
                               ...
                               <div><a href="single-blog.html" class="read-more-btn">read more <i class="fa fa-angle-right"></i></a></div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="widget about-me"> <!-- widget single -->
                            <h3 class="widget-title">About Ahsan</h3>
                            <img src="assets/img/2.jpg" width="70%" style="margin: 0 auto;">
                        ...
                        <div class="widget social"> <!-- widget single -->
                            <h3 class="widget-title">Ratings</h3>
                                <form class="">
                                    <label class="text-left">Your Ratings: </label>
                                    <span class="text-right fa fa-star checked"></span>
                                    <span class="text-right fa fa-star checked"></span>
                                    <span class="text-right fa fa-star checked"></span>
                                    <span class="text-right fa fa-star checked"></span>
                                    <span class="text-right fa fa-star checke "></span>
                                    <textarea class="text-center" name="" id="" cols=" " rows="2" placeholder="Comments here"></textarea>
                                    <input class="btb btn-success btn-block" type="submit" value="submit" style="width: 50%;margin: 0 auto;">
                                </form>
                        </div>
                        <div class="widget social"> <!-- widget single -->
				...
				<div class="footer_upper_grid">
					<div class="col-md-4 col-sm-4 col-xs-12 footer_GridBlock1">
						<div class="upper-table">
							...
							<p>Join the Gates Notes community to access exclusive content, join the discussion and subscribe to your favorite topics.</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-12 footer_GridBlock1">
						<div class="upper-table" style="padding-top:20%;">
							<p> This is my personal blog, where I share about the people I meet, the books I'm reading, and what I'm learning. I hope that you'll join the conversation.</p>
							<img class="footer_GridBlock_image" src="assets/img/bill.png" alt="Author Image"> 
						</div>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-12 footer_GridBlock1">
						<div class="upper-table">
							<p>
								<strong>“Considering the huge impact that Silicon Valley has on our lives, I’m surprised by how rarely pop culture really gets it right.”
									<a class="theme-color" href="">read more</a>
								</strong>
							</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-12 footer_GridBlock2">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12 footer_GridBlock2">
						<div class="lower-table">
					...
					<div class="row wow zoomIn" data-wow-delay="0.4s">
						<div class="col-md-12 text-center">
							<p>&copy;&nbsp;2018&nbsp;<strong>&nbsp;Ahsan Ahmed</strong>.&nbsp;&nbsp;All Rights Reserved</p>
						</div>
					</div>
				</div>
            </div>
...
<!-- Mirrored from mhbthemes.com/demos/kazo/kazo/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Jun 2018 20:51:58 GMT -->
</html>
