...
<body>
	...
	<div class="page-area">
		<div class="left-side">
			<div class="logo">
				<h2><span>EU</span>Social Book</h2></br>
				...
				<ul>
					...
					<li>
						...
						<ul class="dropdown-content drop-content-1" id="myDropdown">
							...
							<li><a href="all_students.php?students=APPROVED">Approved</a></li>
							<li><a href="all_students.php?students=BLOCKED">Blocked</a></li>
							<li><a href="all_students.php?students=PENDING">Pending</a></li>
						</ul>
					</li>
					...
					<li>
						...
						<ul class="dropdown-content drop-content-1" id="myDropdown">
							...
							<li><a href="all_teacher.php?teachers=APPROVED">Approved</a></li>
							<li><a href="all_teacher.php?teachers=BLOCKED">Blocked</a></li>
							<li><a href="all_teacher.php?teachers=PENDING">Pending</a></li>
						</ul>
					</li>
					...
					<li>
						...
						<ul class="dropdown-content drop-content-2" id="myDropdown">
							<li><a href="update_status.php">Update A new Data </a></li>
							<li><a href="add_Subject.php?subject">Add Subject</a></li>
						</ul>
					</li>
					<li><a href="all_post.php">All Post</a></li>
					<li><a href="all_user.php?subject">All User</a></li>
				</ul>
			</div>
		</div>
...
<?php }?>
							 <li>
								<a href="test.php?dicision=PENDING">See All</a>
							 </li>
