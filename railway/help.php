...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<section class="about-area"style="height:100%;;width:100%;">
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					<div class="about-deatails"style="padding:50%;background-color:transparent;border:0px;">
						
					</div>
				</div>
				<div class="col-sm-6"<div class="about-deatails">
					<div class="about-deatails"style="padding:50%;background-color:transparent;border:0px;">
